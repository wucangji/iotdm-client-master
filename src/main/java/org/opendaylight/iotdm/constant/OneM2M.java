...
//    STATUS_FILE_TRANSFER_SERVER_AUTHENTICATION_FAILURE(BigInteger.valueOf(18)),
    ...
    public static class Name {
        ...
        public enum ResourceAttribute {
            ...
            ALLOWED_APP_IDS("allowedApp-IDs", "aai"),
            ...
            public static String toShortName(String name) {
                for (ResourceAttribute attr : ResourceAttribute.values()) {
        ...
        public enum ComplexType {
            ...
            ACCESS_CONTROL_RULE("accessControlRule", "acr"),
            ACCESS_CONTROL_ORIGINATORS("accessControlOriginators", "acor"),
            ACCESS_CONTROL_OPERATIONS("accessControlOperations", "acop"),
            ACCESS_CONTROL_CONTEXTS("accessControlContexts", "acco"),
            ACCESS_CONTROL_WINDOW("accessControWindow", "actw"),
            ACCESS_CONTROLP_ADDRESSES("accessControlIpAddresses", "acip"),
            IPV4_ADDRESSES("ipv4Addresses", "ipv4"),
            IPV6_ADDRESSES("ipv6Addresses", "ipv6"),
            ACCESS_CONTROL_LOCATION_REGION("accessControlLocationRegion", "aclr"),
            COUNTRY_CODE("countryCode", "accc"),
            CIRC_REGION("circRegion", "accr");
            ...
            public static String toShortName(String name) {
                for (ComplexType attr : ComplexType.values()) {
                    if (attr.fullName.equalsIgnoreCase(name))
                        return attr.shortName;
                }
                return name;
